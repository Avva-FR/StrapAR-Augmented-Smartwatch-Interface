...
{
    public class MsgBinUintS1
    {
        /// <summary>
        /// The type of the message. Add any new message types to the MessageContainer.MessageType enum.
        /// </summary>
        public static MessageContainer.MessageType Type = MessageContainer.MessageType.Sensor1;
        ...
        public MsgBinUintS1(ushort data)
        {
            Data = data;
        }
        ...
        public static MsgBinUintS1 Unpack(MessageContainer container)
        {
            ...
            return new MsgBinUintS1(Result);
        }
    }
}