...
{
    public class MsgBinUintS3
    {
        /// <summary>
        /// The type of the message. Add any new message types to the MessageContainer.MessageType enum.
        /// </summary>
        public static MessageContainer.MessageType Type = MessageContainer.MessageType.Sensor3;
        ...
        public MsgBinUintS3(ushort data)
        {
            Data = data;
        }
        ...
        public static MsgBinUintS3 Unpack(MessageContainer container)
        {
            ...
            return new MsgBinUintS3(Result);
        }
    }
}