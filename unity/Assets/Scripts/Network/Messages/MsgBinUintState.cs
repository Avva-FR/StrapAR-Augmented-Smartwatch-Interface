...
{
    public class MsgBinUintState
    {
        /// <summary>
        /// The type of the message. Add any new message types to the MessageContainer.MessageType enum.
        /// </summary>
        public static MessageContainer.MessageType Type = MessageContainer.MessageType.StateChange;
        ...
        public MsgBinUintState(uint data)
        {
            Data = data;
        }
        ...
        public static MsgBinUintState Unpack(MessageContainer container)
        {
            ...
            return new MsgBinUintState(Result);
        }
    }
}